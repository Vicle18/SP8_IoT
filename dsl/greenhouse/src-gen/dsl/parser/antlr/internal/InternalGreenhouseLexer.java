...
public class InternalGreenhouseLexer extends Lexer {
    ...
    public final void mRULE_ID() throws RecognitionException {
        try {
            int _type = RULE_ID;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalGreenhouse.g:1273:9: ( ( '^' )? ( 'a' .. 'z' | 'A' .. 'Z' | '_' ) ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '0' .. '9' )* )
            // InternalGreenhouse.g:1273:11: ( '^' )? ( 'a' .. 'z' | 'A' .. 'Z' | '_' ) ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '0' .. '9' )*
            {
            // InternalGreenhouse.g:1273:11: ( '^' )?
            int alt1=2;
            ...
            // InternalGreenhouse.g:1273:40: ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '0' .. '9' )*
            loop2:
            do {
                int alt2=2;
    ...
    public final void mRULE_INT() throws RecognitionException {
        try {
            int _type = RULE_INT;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalGreenhouse.g:1275:10: ( ( '0' .. '9' )+ )
            // InternalGreenhouse.g:1275:12: ( '0' .. '9' )+
            {
            // InternalGreenhouse.g:1275:12: ( '0' .. '9' )+
            int cnt3=0;
            loop3:
            do {
                ...
                switch (alt3) {
            	case 1 :
            	    // InternalGreenhouse.g:1275:13: '0' .. '9'
            	    {
            	    matchRange('0','9'); 
    ...
    public final void mRULE_STRING() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalGreenhouse.g:1277:13: ( ( '\"' ( '\\\\' . | ~ ( ( '\\\\' | '\"' ) ) )* '\"' | '\\'' ( '\\\\' . | ~ ( ( '\\\\' | '\\'' ) ) )* '\\'' ) )
            // InternalGreenhouse.g:1277:15: ( '\"' ( '\\\\' . | ~ ( ( '\\\\' | '\"' ) ) )* '\"' | '\\'' ( '\\\\' . | ~ ( ( '\\\\' | '\\'' ) ) )* '\\'' )
            {
            // InternalGreenhouse.g:1277:15: ( '\"' ( '\\\\' . | ~ ( ( '\\\\' | '\"' ) ) )* '\"' | '\\'' ( '\\\\' . | ~ ( ( '\\\\' | '\\'' ) ) )* '\\'' )
            int alt6=2;
            ...
            switch (alt6) {
                case 1 :
                    // InternalGreenhouse.g:1277:16: '\"' ( '\\\\' . | ~ ( ( '\\\\' | '\"' ) ) )* '\"'
                    {
                    match('\"'); 
                    // InternalGreenhouse.g:1277:20: ( '\\\\' . | ~ ( ( '\\\\' | '\"' ) ) )*
                    loop4:
                    do {
                        int alt4=3;
                    ...
                    break;
                case 2 :
                    // InternalGreenhouse.g:1277:48: '\\'' ( '\\\\' . | ~ ( ( '\\\\' | '\\'' ) ) )* '\\''
                    {
                    match('\''); 
                    // InternalGreenhouse.g:1277:53: ( '\\\\' . | ~ ( ( '\\\\' | '\\'' ) ) )*
                    loop5:
                    do {
                        int alt5=3;
    ...
    public final void mRULE_ML_COMMENT() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalGreenhouse.g:1279:17: ( '/*' ( options {greedy=false; } : . )* '*/' )
            // InternalGreenhouse.g:1279:19: '/*' ( options {greedy=false; } : . )* '*/'
            {
            match("/*"); 

            // InternalGreenhouse.g:1279:24: ( options {greedy=false; } : . )*
            loop7:
            do {
                int alt7=2;
    ...
    public final void mRULE_SL_COMMENT() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalGreenhouse.g:1281:17: ( '//' (~ ( ( '\\n' | '\\r' ) ) )* ( ( '\\r' )? '\\n' )? )
            // InternalGreenhouse.g:1281:19: '//' (~ ( ( '\\n' | '\\r' ) ) )* ( ( '\\r' )? '\\n' )?
            {
            match("//"); 

            // InternalGreenhouse.g:1281:24: (~ ( ( '\\n' | '\\r' ) ) )*
            loop8:
            do {
                int alt8=2;
            ...
            // InternalGreenhouse.g:1281:40: ( ( '\\r' )? '\\n' )?
            int alt10=2;
            ...
            switch (alt10) {
                case 1 :
                    // InternalGreenhouse.g:1281:41: ( '\\r' )? '\\n'
                    {
                    // InternalGreenhouse.g:1281:41: ( '\\r' )?
                    int alt9=2;
    ...
    public final void mRULE_WS() throws RecognitionException {
        try {
            int _type = RULE_WS;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalGreenhouse.g:1283:9: ( ( ' ' | '\\t' | '\\r' | '\\n' )+ )
            // InternalGreenhouse.g:1283:11: ( ' ' | '\\t' | '\\r' | '\\n' )+
            {
            // InternalGreenhouse.g:1283:11: ( ' ' | '\\t' | '\\r' | '\\n' )+
            int cnt11=0;
            loop11:
    ...
    public final void mRULE_ANY_OTHER() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalGreenhouse.g:1285:16: ( . )
            // InternalGreenhouse.g:1285:18: .
            {
            matchAny(); 
    ...
    static final String DFA12_eotS =
        "\1\uffff\2\35\2\uffff\4\35\1\uffff\3\35\3\uffff\2\35\1\31\2\uffff\3\31\2\uffff\3\35\1\uffff\2\35\2\uffff\4\35\1\102\3\35\1\uffff\3\35\3\uffff\1\112\1\113\5\uffff\2\35\1\117\3\35\1\123\3\35\1\uffff\1\35\1\130\1\131\1\132\3\35\2\uffff\3\35\1\uffff\3\35\1\uffff\1\35\1\145\2\35\3\uffff\2\35\1\152\7\35\1\uffff\2\35\1\164\1\35\1\uffff\1\166\1\167\1\35\1\171\1\35\1\173\3\35\1\uffff\1\35\2\uffff\1\u0080\1\uffff\1\35\1\uffff\4\35\1\uffff\2\35\1\u0088\1\u0089\1\u008a\1\35\1\u008c\3\uffff\1\u008d\2\uffff";
    ...
    static final String DFA12_acceptS =
        "\3\uffff\1\3\1\4\4\uffff\1\12\3\uffff\1\21\1\22\1\23\3\uffff\1\34\1\35\3\uffff\1\41\1\42\3\uffff\1\34\2\uffff\1\3\1\4\10\uffff\1\12\3\uffff\1\21\1\22\1\23\2\uffff\1\35\1\36\1\37\1\40\1\41\12\uffff\1\33\7\uffff\1\26\1\30\3\uffff\1\32\3\uffff\1\5\4\uffff\1\16\1\11\1\14\12\uffff\1\31\4\uffff\1\20\11\uffff\1\15\1\uffff\1\1\1\13\1\uffff\1\17\1\uffff\1\7\4\uffff\1\27\7\uffff\1\6\1\10\1\24\1\uffff\1\25\1\2";
